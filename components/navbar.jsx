...
const NavBar = props => {
      ...
      if(index  === (array.length - 1)) {
        navBarLinks.push(
          <li className="" key = {index}>
            ...
            <a className="text-shadow shadow-white text-white hover:text-blue-100 bg-pink-400 pl-2 pr-10 font-semibold -mr-10" href={element.link}>APPLY NOW </a>
          </li>
        )
      }
      else {
  ...
  return <nav className="flex fixed inset-x-0 px-2 sm:px-4 py-2.5 bg-black font-roboto w-full z-50 py-5">
    <div className="flex flex-wrap mx-auto bg-black">
        {/* <a href="#home" className="flex bg-black">

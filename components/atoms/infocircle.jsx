...
<div className="relative hover:scale-105 transition duration-500 object-cover">
  ...
  <div className="absolute inset-0 flex items-center w-auto">
    <div className="3xl:ml-10 2xl:ml-14 xl:ml-20 md:ml-20 lg:ml-24 sm:ml-7 circle-text-ml text-white text-center xl:text-xl lg:text-xl md:text-xl sm:text-xs text-xs md:w-2/5 w-3/4">{text}</div>
  </div>
</div>
  );
};
